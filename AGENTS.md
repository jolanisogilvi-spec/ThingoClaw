...
- **Doc sync rule**: After any functional or architecture change, review `README.md` for required updates; if behavior/flows/interfaces changed, update docs in the same PR/commit.
