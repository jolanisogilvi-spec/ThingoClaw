...
if /i "%1"=="update" (
    echo openclaw is managed by ThingoClaw ^(bundled version^).
    echo.
    echo To update openclaw, update ThingoClaw:
    echo   Open ThingoClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=ThingoClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\ThingoClaw.exe" "%OPENCLAW_ENTRY%" %*
)
