...
const FATAL_EXTRACT_FAILURE_DETAIL = 'Failed to extract ThingoClaw files after multiple attempts.';
const ROLLBACK_EXTRACT_FAILURE_DETAIL = 'Restoring previous ThingoClaw installation after failed update';
...
const PATCHED_EXTRACT_MACRO = [
  ...
  '    ${endIf}',
  '    DetailPrint "Failed to extract ThingoClaw files after multiple attempts."',
  '    ${if} $clawxRollbackDir != ""',
  '      IfFileExists "$clawxRollbackDir\\" 0 clawx_extract_show_error',
  '      DetailPrint "Restoring previous ThingoClaw installation after failed update..."',
  '      SetOutPath $TEMP',
  '      RMDir /r "$INSTDIR"',
