...
describe('installer.nsh running-app guard', () => {
  it('fails closed when the app executable remains alive during overwrite install', () => {
    ...
    expect(guard).toContain('ThingoClaw is still running and cannot be replaced safely');
